...
Size _imzaCardSize(BuildContext context) {
  ...
  return Size(math.min(s.width * 0.90, 400), math.min(s.height * 0.78, 560));
}
          ...
          child: SafeArea(
            ...
            child: LayoutBuilder(
              builder: (context, constraints) {
                ...
                final cardW = math.min(availableSize.width * 0.55, 280.0);
                final cardH = math.min(availableSize.height, 280.0);
                  ...
                  child: Container(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(
                          color: _stain.withValues(alpha: 0.3),
                          width: 2,
                        ),
                      ),
                      child: ClipRRect(
